...
async def execute_scraping_coordinator():
    ...
    try:
        ...
        # Log de resultados
        logger.info(f"Coordinador finalizado - Artículos scrapeados: {result['total_articles_scraped']}")
...
def example_cron_setup():
    ...
    crontab -l
    """
    print("Para configurar con cron, seguir las instrucciones en los comentarios de esta función")
...
def example_apscheduler():
    ...
    async def scheduled_job():
        ...
        try:
            ...
            logger.info(f"Job programado completado - Jobs exitosos: {result['total_jobs_completed']}")
        except Exception as e:
...
def example_schedule():
    ...
    def job():
        ...
        try:
            ...
            logger.info(f"Job completado - Artículos: {result['total_articles_scraped']}")
        except Exception as e:
