...
class TestLaNacionScraper:
    ...
    def test_scraper_handles_network_errors_gracefully(self):
        ...
        with patch('src.infrastructure.adapters.scrapers.lanacion_scraper.requests.Session') as mock_session_class:
            mock_session = Mock()
            mock_session_class.return_value = mock_session
    ...
    def test_scraper_filters_unwanted_urls(self):
        ...
        with patch.object(scraper.session, 'get', return_value=mock_response):
            urls = scraper._extract_article_urls_from_section("https://www.lanacion.com.ar/politica/")
