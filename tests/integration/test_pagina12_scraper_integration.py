...
class TestPagina12ScraperIntegration:
    ...
    async def test_full_scraping_and_persistence_flow(self):
        ...
        await sync_to_async(NewsArticleModel.objects.filter(fuente="Página 12").delete)()
        ...
        try:
            ...
            total_in_db = await sync_to_async(NewsArticleModel.objects.filter(fuente="Página 12").count)()
