...
def main():
    ...
    checks.append(
        check_file_exists(
            "src/infrastructure/config/django_settings.py", "Django settings"
        )
    )
    checks.append(
        check_file_exists("src/infrastructure/config/wsgi.py", "WSGI application")
    )
    checks.append(
        check_file_exists("src/infrastructure/config/asgi.py", "ASGI application")
    )
    print()
    ...
    print("-" * 70)
    checks.append(
        check_file_exists("src/domain/entities/news_article.py", "NewsArticle entity")
    )
    checks.append(check_file_exists("src/domain/entities/source.py", "Source entity"))
    checks.append(
        check_file_exists("src/domain/entities/scraping_job.py", "ScrapingJob entity")
    )
    checks.append(
        check_file_exists(
            "src/domain/repositories/news_article_repository.py",
            "NewsArticle repository interface",
        )
    )
    checks.append(
        check_file_exists(
    ...
    checks.append(
        check_file_exists(
            ...
            "ScrapingJob repository interface",
        )
    )
    print()
    ...
    print("-" * 70)
    checks.append(
        check_file_exists("src/application/dto/news_article_dto.py", "NewsArticle DTOs")
    )
    checks.append(check_file_exists("src/application/dto/source_dto.py", "Source DTOs"))
    checks.append(
        check_file_exists("src/application/dto/scraping_job_dto.py", "ScrapingJob DTOs")
    )
    checks.append(
        check_file_exists(
            "src/application/use_cases/create_article.py", "CreateArticle use case"
        )
    )
    checks.append(
        check_file_exists(
            "src/application/use_cases/list_articles.py", "ListArticles use case"
        )
    )
    checks.append(
        check_file_exists(
            "src/application/use_cases/register_source.py", "RegisterSource use case"
        )
    )
    print()
    ...
    checks.append(
        check_file_exists(
            "src/infrastructure/persistence/django_app/models.py", "Django models"
        )
    )
    checks.append(
        check_file_exists(
            "src/infrastructure/persistence/django_app/admin.py", "Django admin"
        )
    )
    checks.append(
        check_file_exists(
            "src/infrastructure/persistence/django_app/apps.py", "Django app config"
        )
    )
    checks.append(
        check_file_exists(
    ...
    checks.append(
        check_file_exists(
            "src/presentation/django_app/serializers.py", "DRF serializers"
        )
    )
    checks.append(
        check_file_exists("src/presentation/django_app/views.py", "DRF views")
    )
    checks.append(
        check_file_exists("src/presentation/django_app/urls.py", "URL routing")
    )
    print()
    ...
    checks.append(
        check_file_exists("MIGRATION_TO_DJANGO.md", "Migration documentation")
    )
    ...
    print("-" * 70)
    checks.append(
        check_file_exists("tests/unit/test_news_article_entity.py", "NewsArticle tests")
    )
    checks.append(check_file_exists("tests/unit/test_source_entity.py", "Source tests"))
    checks.append(
        check_file_exists("tests/unit/test_scraping_job_entity.py", "ScrapingJob tests")
    )
