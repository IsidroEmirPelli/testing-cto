...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("scraping_coordinator.log")],
)
...
async def main():
    ...
    try:
        ...
        print(
            f"Total duplicados omitidos: {result['total_articles_scraped'] - result['total_articles_persisted']}"
        )
        print("=" * 80)
