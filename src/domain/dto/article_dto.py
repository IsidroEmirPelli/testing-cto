...
class ArticleDTO(BaseModel):
    ...
    contenido: Optional[str] = Field(None, description="Contenido completo del artículo")
    fecha_publicacion: Optional[datetime] = Field(None, description="Fecha de publicación del artículo")
    fuente: str = Field(..., description="Nombre de la fuente (ej: 'Clarín', 'Página 12')")
