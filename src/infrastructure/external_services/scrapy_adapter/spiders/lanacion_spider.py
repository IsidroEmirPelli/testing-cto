...
class LaNacionSpider(BaseNewsSpider):
    ...
    def parse_article(self, response):
        try:
            ...
            paragraphs = response.css('div.nota p::text, article p::text, div.contenido p::text').getall()
            ...
            categoria = response.css('div.com-breadcrumb a::text, nav.breadcrumb a::text').getall()
